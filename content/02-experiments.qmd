...
However, proving that changes to one factor (more local voting booths, factionalization, or trade) caused changes to our outcome of interest is very difficult to do. This is because we need to prove that all the other things that changed when our outcome of interest changed weren't the ones really driving that outcome. How do we do this?
