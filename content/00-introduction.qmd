...
The course comprises twelve substantive sessions. You should complete these in order: each builds on the previous sessions. Each includes some written content, a worked example of the concepts being discussed, and relevant R code. Some include short recorded lectures.
...
You will also complete a final exam at the end of the course. All material covered in all twelve sessions will be tested.
...
Head over to ELMs to complete this session's quiz. You need to score 100% on it to gain access to the next session's quiz.
